...
def monitor_and_exit(positions: dict, force_all: bool = False):
    ...
    for key in list(positions.keys()):
        ...
        sellable = get_overseas_sellable_qty(sym, p.get("exchange", "NASD"))
        ...
        if res.get("rt_cd") != "0":
            ...
            if get_overseas_sellable_qty(sym, p.get("exchange", "NASD")) <= 0:
        ...
        remaining = get_overseas_sellable_qty(sym, p.get("exchange", "NASD"))
        if remaining <= 0:
